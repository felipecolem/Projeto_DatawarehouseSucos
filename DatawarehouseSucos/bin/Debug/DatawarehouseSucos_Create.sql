...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '503858e3-a938-48d6-a199-5ef931c3f97e')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('503858e3-a938-48d6-a199-5ef931c3f97e')
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '12a98817-3f10-4c66-af77-a93b7def2834')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('12a98817-3f10-4c66-af77-a93b7def2834')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b9171cce-89a5-4d26-9dc4-dde1813f538f')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b9171cce-89a5-4d26-9dc4-dde1813f538f')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'bac7d96e-9355-4d73-b9f2-dba3c0b06e1a')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('bac7d96e-9355-4d73-b9f2-dba3c0b06e1a')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '1d2591ec-5320-406e-973b-8c50a7aaa2af')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('1d2591ec-5320-406e-973b-8c50a7aaa2af')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '003695fa-a9d1-4269-99a9-b6aba3b0c864')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('003695fa-a9d1-4269-99a9-b6aba3b0c864')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '30108eef-0e99-4da8-b4ac-d144fa5f7a20')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('30108eef-0e99-4da8-b4ac-d144fa5f7a20')

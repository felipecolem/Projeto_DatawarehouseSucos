...
GO
PRINT N'Rename refactoring operation with key 1d2591ec-5320-406e-973b-8c50a7aaa2af is skipped, element [dbo].[Fato_001].[Id] (SqlSimpleColumn) will not be renamed to Cod_Cliente';


GO
PRINT N'Rename refactoring operation with key 003695fa-a9d1-4269-99a9-b6aba3b0c864 is skipped, element [dbo].[Fato_001].[Faturament] (SqlSimpleColumn) will not be renamed to Faturamento';


GO
PRINT N'Rename refactoring operation with key 30108eef-0e99-4da8-b4ac-d144fa5f7a20 is skipped, element [dbo].[Fato_003].[Frete] (SqlSimpleColumn) will not be renamed to Custo_Fixo';
